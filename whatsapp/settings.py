...
ALLOWED_HOSTS = ["whatsapp-clone69.herokuapp.com"]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'whatsapp-clone/build')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [os.path.join(BASE_DIR,'whatsapp-clone/build/static')]

CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "http://127.0.0.1:8000",
    "https://whatsapp-clone69.herokuapp.com",
]
